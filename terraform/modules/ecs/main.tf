# ==============================================================================
# ECS Module: VPC, ALB, Target Group, ECS Fargate Cluster & Service
# ==============================================================================
...
resource "aws_security_group" "alb" {
  ...
  ingress {
    description = "Allow HTTP inbound from public"
    from_port   = 80
    to_port     = 80
    protocol    = "tcp"
...
resource "aws_security_group" "ecs_tasks" {
  ...
  description = "Allows inbound traffic only from the ALB to ECS container tasks"
  vpc_id      = aws_vpc.main.id
  ...
  egress {
    description = "Allow all outbound traffic (for ECR image pulls, AWS APIs)"
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
    cidr_blocks = ["0.0.0.0/0"]
